          ...
          <table className="min-w-full divide-y divide-gray-200" data-testid="code-systems-table">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredCodeSystems.map((cs) => (
                <tr key={cs.id} data-testid={`code-system-row-${cs.id}`} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">
                    {cs.count || cs.concept?.length || 0}
                  </td>
                  <td className="px-6 py-4 text-right text-sm font-medium space-x-2">
                    <Link
                      to={`/code-systems/${cs.id}`}
                      data-testid={`view-button-${cs.id}`}
                    ...
                    <button
                      ...
                      data-testid={`delete-button-${cs.id}`}
